    ...
    this.form = this._formBuilder.group(
      {
        ...
        inputLastName: ["", [Validators.required, Validators.minLength(5), Validators.maxLength(10)]],
        inputAge: ["", [Validators.required, Validators.min(1), Validators.max(20)]],
      }
    );
