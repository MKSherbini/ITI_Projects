    ...
    public void switchToLab1Scene() {
        ...
        if (!scenes.containsKey("lab1")) {
            try {
                ...
                System.out.println("IO Exception: Couldn't load 'lab1 View' FXML file");
            }
        } else {
