...
public class User  implements java.io.Serializable {
    ...
    public User(int id, String email, String address, String phone, String mobile, Date dateOfBirth, Date registrationDate, String userName, String password, String fullName, Set<Buyer> buyers, Seller seller) {
       this.id = id;
       this.email = email;
