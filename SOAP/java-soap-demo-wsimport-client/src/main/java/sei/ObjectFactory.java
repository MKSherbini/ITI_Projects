...
public class ObjectFactory {
    ...
    private final static QName _AddEmployee_QNAME = new QName("http://jets.iti.gov.eg/", "addEmployee");
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://jets.iti.gov.eg/", "addEmployeeResponse");
    private final static QName _DeleteEmployee_QNAME = new QName("http://jets.iti.gov.eg/", "deleteEmployee");
    private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://jets.iti.gov.eg/", "deleteEmployeeResponse");
    private final static QName _GetEmployee_QNAME = new QName("http://jets.iti.gov.eg/", "getEmployee");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://jets.iti.gov.eg/", "getEmployeeResponse");
    private final static QName _UpdateEmployee_QNAME = new QName("http://jets.iti.gov.eg/", "updateEmployee");
    private final static QName _UpdateEmployeeResponse_QNAME = new QName("http://jets.iti.gov.eg/", "updateEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sei
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "addEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "addEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "deleteEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "deleteEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "getEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "getEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "updateEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://jets.iti.gov.eg/", name = "updateEmployeeResponse")
